...
The notebooks all use the :doc:`open model hub <../open-model-hub/index>`: a toolkit that contains pre-built product analytics models 
...
.. admonition:: Try the notebooks with demo data
