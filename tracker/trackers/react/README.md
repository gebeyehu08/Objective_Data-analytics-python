...
Objectiv tracker for React applications that embraces the [open analytics taxonomy](https://objectiv.io/docs/taxonomy/). Supports core tracking methods and default auto-tracking (ApplicationLoaded) out of the box.
